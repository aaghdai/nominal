...
class TestNominalReaderIntegration(unittest.TestCase):
    ...
    def test_read_text_pdf(self):
        ...
        # Note: We might need to adjust these assertions based on the actual content of Sample-W2.pdf
        self.assertTrue(len(content) > 0, "Content should not be empty")
        content = content.lower()
        # Common W2 keywords
        self.assertTrue("w-2" in content or "wage and tax statement" in content,
    ...
    def test_read_image_pdf_with_ocr(self):
        ...
        self.assertTrue("1099" in content, 
                        f"Expected 1099 content, got: {content[:100]}...")
